...
const NewsItems = (props) => {
    ...
    if (!links.length) {
      try {
        ...
        const response = await axios.get(
          `http://localhost:3001/search?query=${props.title}`
        );
  ...
  return (
    <>
      <div
        ref={ref}
        className={`card text-${props.mode === "light" ? "dark" : "light"} bg-${
      ...
      >
        <div className="row align-items-start justify-content-start">
          <img
            ...
            alt={source}
            height={imgHeight > 400 ? "auto" : imgHeight}
          />
        ...
        >
          <button
            ...
            data-bs-target={"#links" + props.index}
            aria-expanded="false"
            aria-controls={"links" + props.index}
      ...
      <div className="collapse" id={"links" + props.index}>
        <div
          className={`card card-body my-2 bg-${
